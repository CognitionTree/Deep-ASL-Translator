...
def experiment_conv():
	model_name = 'Convolutional Model'
...
#experiment_lstm(None, 21)
#experiment_lstm('max', 21)
#experiment_lstm('avg', 21)

#experiment_lstm(None, 35)
#experiment_lstm('max', 35)
#experiment_lstm('avg', 35)
